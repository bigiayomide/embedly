...
public class WebhookValidationException : EmbedlyException
{
    ...
    public WebhookValidationException(string message, WebhookValidationType validationType = WebhookValidationType.Signature)
    ...
    public static WebhookValidationException InvalidSignature(string? details = null)
    {
        ...
        return new WebhookValidationException(message, WebhookValidationType.Signature);
    }

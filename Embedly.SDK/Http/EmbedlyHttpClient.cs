...
internal sealed class EmbedlyHttpClient : IEmbedlyHttpClient, IDisposable
{
    ...
    /// <inheritdoc />
    public async Task<ApiResponse<T>> PostAsync<T>(string endpoint, object? content = null, CancellationToken cancellationToken = default)
    {
        Guard.ThrowIfNullOrWhiteSpace(endpoint, nameof(endpoint));
    ...
    /// <inheritdoc />
    public async Task<ApiResponse<T>> PutAsync<T>(string endpoint, object? content = null, CancellationToken cancellationToken = default)
    {
        Guard.ThrowIfNullOrWhiteSpace(endpoint, nameof(endpoint));
    ...
    /// <inheritdoc />
    public async Task<ApiResponse<T>> PatchAsync<T>(string endpoint, object? content = null, CancellationToken cancellationToken = default)
    {
        Guard.ThrowIfNullOrWhiteSpace(endpoint, nameof(endpoint));
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            throw new OperationCanceledException($"Request to {method} {endpoint} was cancelled", ex, cancellationToken);
        }
    }

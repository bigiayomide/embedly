...
public interface IEmbedlyHttpClient
{
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>The API response wrapped in ApiResponse.</returns>
    Task<ApiResponse<T>> GetAsync<T>(string endpoint, Dictionary<string, object?> queryParams,
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>The API response wrapped in ApiResponse.</returns>
    Task<ApiResponse<T>> PostAsync<T>(string endpoint, object? content = null,
        CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>The API response wrapped in ApiResponse.</returns>
    Task<ApiResponse<T>> PutAsync<T>(string endpoint, object? content = null,
        CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>The API response wrapped in ApiResponse.</returns>
    Task<ApiResponse<T>> PatchAsync<T>(string endpoint, object? content = null,
        CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>The API response wrapped in ApiResponse.</returns>
    Task<ApiResponse<TResponse>> PatchAsync<TRequest, TResponse>(string endpoint, TRequest request,
        CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>The API response wrapped in ApiResponse.</returns>
    Task<ApiResponse<T>> PostMultipartAsync<T>(string endpoint, Stream fileStream, string fileName,

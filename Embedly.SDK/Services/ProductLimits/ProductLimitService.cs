...
internal sealed class ProductLimitService : BaseService, IProductLimitService
{
    ...
    /// <inheritdoc />
    public async Task<ApiResponse<ProductLimit>> CreateProductLimitAsync(CreateProductLimitRequest request,
    ...
    /// <inheritdoc />
    public async Task<ApiResponse<ProductLimit>> GetProductLimitAsync(string limitId,
        CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc />
    public async Task<ApiResponse<PaginatedResponse<ProductLimit>>> GetProductLimitsAsync(
        GetProductLimitsRequest request, CancellationToken cancellationToken = default)
    {
        Guard.ThrowIfNull(request, nameof(request));

        var url = BuildUrl("api/v1/product-limits");
        return await HttpClient.GetAsync<PaginatedResponse<ProductLimit>>(url, request.ToQueryParameters(),
            cancellationToken);
    }

    /// <inheritdoc />
    public async Task<ApiResponse<List<ProductLimit>>> GetProductLimitsByProductAsync(string productId,
        CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc />
    public async Task<ApiResponse<ProductLimit>> UpdateProductLimitAsync(string limitId,
        CreateProductLimitRequest request, CancellationToken cancellationToken = default)
    {
        Guard.ThrowIfNullOrWhiteSpace(limitId, nameof(limitId));
        Guard.ThrowIfNull(request, nameof(request));
    ...
    /// <inheritdoc />
    public async Task<ApiResponse<ProductLimit>> ActivateProductLimitAsync(string limitId,
        CancellationToken cancellationToken = default)
    {
        Guard.ThrowIfNullOrWhiteSpace(limitId, nameof(limitId));
    ...
    /// <inheritdoc />
    public async Task<ApiResponse<ProductLimit>> DeactivateProductLimitAsync(string limitId,
        CancellationToken cancellationToken = default)
    {
        Guard.ThrowIfNullOrWhiteSpace(limitId, nameof(limitId));
    ...
    /// <inheritdoc />
    public async Task<ApiResponse<ProductLimit>> ResetProductLimitUsageAsync(string limitId,
        CancellationToken cancellationToken = default)
    {
        Guard.ThrowIfNullOrWhiteSpace(limitId, nameof(limitId));
    ...
    /// <inheritdoc />
    public async Task<ApiResponse<object>> DeleteProductLimitAsync(string limitId,
        CancellationToken cancellationToken = default)
    {
        Guard.ThrowIfNullOrWhiteSpace(limitId, nameof(limitId));

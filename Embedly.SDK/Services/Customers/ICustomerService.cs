...
public interface ICustomerService
{
    ...
    Task<ApiResponse<Customer>> CreateAsync(CreateCustomerRequest request, CancellationToken cancellationToken = default);
    ...
    Task<ApiResponse<IEnumerable<Customer>>> GetAllAsync(int page = 1, int pageSize = 50, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>The API response containing a list of customers.</returns>
    Task<ApiResponse<IEnumerable<Customer>>> GetAllAsync(GetCustomersRequest request, CancellationToken cancellationToken = default);
    ...
    Task<ApiResponse<Customer>> UpdateNameAsync(string customerId, string firstName, string lastName, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>The API response containing the updated customer.</returns>
    Task<ApiResponse<Customer>> UpdateNameAsync(UpdateCustomerNameRequest request, CancellationToken cancellationToken = default);
    ...
    Task<ApiResponse<CustomerVerificationProperties>> GetVerificationPropertiesAsync(string customerId, CancellationToken cancellationToken = default);
    ...
    Task<ApiResponse<KycUpgradeResult>> UpgradeKycWithNinAsync(NinKycUpgradeRequest request, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>The API response containing the KYC upgrade result.</returns>
    Task<ApiResponse<KycUpgradeResult>> UpgradeKycWithBvnAsync(BvnKycUpgradeRequest request, CancellationToken cancellationToken = default);
    ...
    Task<ApiResponse<AddressVerificationResult>> VerifyAddressAsync(AddressVerificationRequest request, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>The API response containing the updated customer.</returns>
    Task<ApiResponse<Customer>> UpdateCustomerTypeAsync(string customerId, string customerTypeId, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>The API response containing the updated customer.</returns>
    Task<ApiResponse<Customer>> UpdateContactAsync(string customerId, UpdateCustomerContactRequest request, CancellationToken cancellationToken = default);
}
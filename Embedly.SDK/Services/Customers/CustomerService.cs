...
internal sealed class CustomerService : BaseService, ICustomerService
{
    ...
    /// <inheritdoc />
    public async Task<ApiResponse<Customer>> CreateAsync(CreateCustomerRequest request,
    ...
    /// <inheritdoc />
    public async Task<ApiResponse<Customer>> GetByIdAsync(string customerId,
        CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc />
    public async Task<ApiResponse<IEnumerable<Customer>>> GetAllAsync(int page = 1, int pageSize = 50,
        CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc />
    public async Task<ApiResponse<IEnumerable<Customer>>> GetAllAsync(GetCustomersRequest request,
        CancellationToken cancellationToken = default)
    {
        Guard.ThrowIfNull(request, nameof(request));
    ...
    /// <inheritdoc />
    public async Task<ApiResponse<CustomerVerificationProperties>> GetVerificationPropertiesAsync(string customerId,
        CancellationToken cancellationToken = default)
    {
        Guard.ThrowIfNullOrWhiteSpace(customerId, nameof(customerId));
    ...
    /// <inheritdoc />
    public async Task<ApiResponse<IEnumerable<CustomerType>>> GetCustomerTypesAsync(
        CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc />
    public async Task<ApiResponse<IEnumerable<Country>>> GetCountriesAsync(
        CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc />
    public async Task<ApiResponse<Customer>> UpdateCustomerTypeAsync(string customerId, string customerTypeId,
        CancellationToken cancellationToken = default)
    {
        Guard.ThrowIfNullOrWhiteSpace(customerId, nameof(customerId));
        ...
        var url = BuildUrl(ServiceUrls.Base,
            $"api/v1/customers/customer/{customerId}/customertype/{customerTypeId}/update");

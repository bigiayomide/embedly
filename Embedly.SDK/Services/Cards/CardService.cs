...
internal sealed class CardService : BaseService, ICardService
{
    ...
    public CardService(IEmbedlyHttpClient httpClient, IOptions<EmbedlyOptions> options, IPinEncryptionService pinEncryptionService)
        : base(httpClient, options)
    {
        _pinEncryptionService = pinEncryptionService ?? throw new System.ArgumentNullException(nameof(pinEncryptionService));
    }
    ...
    public async Task<ApiResponse<AfrigoCard>> ActivateAfrigoCardAsync(ActivateAfrigoCardRequest request, CancellationToken cancellationToken = default)
    {
        ...
        return await HttpClient.PostAsync<ActivateAfrigoCardRequest, AfrigoCard>(url, processedRequest, cancellationToken);
    }
    ...
    public async Task<ApiResponse<CardPinOperationResult>> ResetCardPinAsync(ResetCardPinRequest request, CancellationToken cancellationToken = default)
    {
        ...
        return await HttpClient.PostAsync<ResetCardPinRequest, CardPinOperationResult>(url, processedRequest, cancellationToken);
    }
    ...
    public async Task<ApiResponse<CardPinOperationResult>> ChangeCardPinAsync(ChangeCardPinRequest request, CancellationToken cancellationToken = default)
    {
        ...
        return await HttpClient.PostAsync<ChangeCardPinRequest, CardPinOperationResult>(url, processedRequest, cancellationToken);
    }
    ...
    public async Task<ApiResponse<CardPinOperationResult>> CheckCardPinAsync(CheckCardPinRequest request, CancellationToken cancellationToken = default)
    {
        ...
        return await HttpClient.PostAsync<CheckCardPinRequest, CardPinOperationResult>(url, processedRequest, cancellationToken);
    }

...
internal sealed class PayoutService : BaseService, IPayoutService
{
    ...
    /// <inheritdoc />
    public async Task<ApiResponse<List<Bank>>> GetBanksAsync(string? search = null, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc />
    public async Task<ApiResponse<OrganizationPayoutData>> GetOrganizationPayoutDataAsync(Guid organizationId, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc />
    public async Task<ApiResponse<List<PayoutTransaction>>> GetAllPayoutsAsync(CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc />
    public async Task<ApiResponse<GlobalPayoutLimit>> EnableOrDisableGlobalPayoutLimitAsync(Guid limitId, bool enabled, CancellationToken cancellationToken = default)
    {
        var url = BuildUrl(ServiceUrls.Payout, $"api/operations/payout-limits/global-limit/enable-or-disable?enable={enabled}&limitId={limitId}");

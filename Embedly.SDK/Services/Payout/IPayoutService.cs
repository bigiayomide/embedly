...
public interface IPayoutService
{
    ...
    Task<ApiResponse<NameEnquiryResponse>> NameEnquiryAsync(NameEnquiryRequest request,
    ...
    Task<ApiResponse<OrganizationPayoutData>> GetOrganizationPayoutDataAsync(Guid organizationId,
        CancellationToken cancellationToken = default);
    ...
    Task<ApiResponse<PayoutProfileResponse>> CreatePayoutProfileAsync(PayoutRequestDto request,
        CancellationToken cancellationToken = default);
    ...
    Task<ApiResponse<WalletDetails>> GetWalletByAccountNumberAsync(string accountNumber,
        CancellationToken cancellationToken = default);
    ...
    Task<ApiResponse<GlobalPayoutLimit>> AddGlobalPayoutLimitAsync(AddGlobalPayoutLimitRequest request,
        CancellationToken cancellationToken = default);
    ...
    Task<ApiResponse<PaginatedResponse<GlobalPayoutLimit>>> GetGlobalPayoutLimitsAsync(GetPayoutLimitsRequest request,
        CancellationToken cancellationToken = default);
    ...
    Task<ApiResponse<GlobalPayoutLimit>> UpdateGlobalPayoutLimitAsync(Guid globalLimitId,
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>The updated global payout limit.</returns>
    Task<ApiResponse<GlobalPayoutLimit>> UpdateOrganizationCurrencyLimitAsync(Guid organizationId, Guid currencyId,
        AddGlobalPayoutLimitRequest request, CancellationToken cancellationToken = default);
    ...
    Task<ApiResponse<GlobalPayoutLimit>> CreateDefaultGlobalPayoutLimitAsync(AddGlobalPayoutLimitRequest request,
        CancellationToken cancellationToken = default);
    ...
    Task<ApiResponse<GlobalPayoutLimit>> UpdateDefaultGlobalPayoutLimitAsync(Guid defaultLimitId,
        AddGlobalPayoutLimitRequest request, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>The updated global payout limit.</returns>
    Task<ApiResponse<GlobalPayoutLimit>> EnableOrDisableGlobalPayoutLimitAsync(Guid limitId, bool enabled,
        CancellationToken cancellationToken = default);
}
...
internal sealed class WalletGroupService : BaseService, IWalletGroupService
{
    ...
    /// <inheritdoc />
    public async Task<ApiResponse<List<WalletGroup>>> GetWalletGroupsAsync(CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc />
    public async Task<ApiResponse<List<WalletGroupFeature>>> GetWalletGroupFeaturesAsync(CancellationToken cancellationToken = default)
    {

...
public interface IWalletGroupService
{
    ...
    Task<ApiResponse<WalletGroup>> CreateWalletGroupAsync(CreateWalletGroupRequest request, CancellationToken cancellationToken = default);
    ...
    Task<ApiResponse<object>> AddWalletGroupFeatureAsync(AddWalletGroupFeatureRequest request, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>Success response.</returns>
    Task<ApiResponse<object>> AddWalletToGroupAsync(string id, string walletId, CancellationToken cancellationToken = default);
    ...
    Task<ApiResponse<List<WalletGroupFeature>>> GetWalletGroupFeaturesAsync(CancellationToken cancellationToken = default);
}
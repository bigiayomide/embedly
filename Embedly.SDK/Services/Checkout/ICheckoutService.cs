...
public interface ICheckoutService
{
    ...
    Task<ApiResponse<CheckoutWallet>> GenerateCheckoutWalletAsync(GenerateCheckoutWalletRequest request, CancellationToken cancellationToken = default);
    ...
    Task<ApiResponse<List<CheckoutWallet>>> GetCheckoutWalletsAsync(GetCheckoutWalletsRequest request, CancellationToken cancellationToken = default);
    ...
    Task<ApiResponse<CheckoutWallet>> GetCheckoutWalletWithTransactionsAsync(Guid walletId, Guid organizationId, CancellationToken cancellationToken = default);
}
...
public interface IUtilityService
{
    ...
    Task<ApiResponse<Currency>> CreateCurrencyAsync(CreateCurrencyRequest request,
    ...
    Task<ApiResponse<Country>> CreateCountryAsync(CreateCountryRequest request,
        CancellationToken cancellationToken = default);
    ...
    Task<ApiResponse<FileUploadResponse>> UploadFileAsync(Stream fileStream, string fileName,

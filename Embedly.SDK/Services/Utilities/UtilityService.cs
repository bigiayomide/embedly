...
internal sealed class UtilityService : BaseService, IUtilityService
{
    ...
    /// <inheritdoc />
    public async Task<ApiResponse<List<Currency>>> GetCurrenciesAlternateAsync(
    ...
    /// <inheritdoc />
    public async Task<ApiResponse<Currency>> CreateCurrencyAsync(CreateCurrencyRequest request,
        CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc />
    public async Task<ApiResponse<List<Country>>> GetCountriesAlternateAsync(
        CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc />
    public async Task<ApiResponse<Country>> CreateCountryAsync(CreateCountryRequest request,
        CancellationToken cancellationToken = default)
    {
        Guard.ThrowIfNull(request, nameof(request));
    ...
    /// <inheritdoc />
    public async Task<ApiResponse<FileUploadResponse>> UploadFileAsync(Stream fileStream, string fileName,
        string contentType = "application/octet-stream", CancellationToken cancellationToken = default)
    {
        ...
        return await HttpClient.PostMultipartAsync<FileUploadResponse>(url, fileStream, fileName, contentType,
            cancellationToken);
    }
}